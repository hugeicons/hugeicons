...
Hugeicons is a beautiful [icon library](https://hugeicons.com/solid-icons) for modern web and mobile apps. The free package includes 5,400+ Stroke Rounded SolidJS icons. The Pro package provides 54,000+ SolidJS icons across 10 styles, including multicolor support for Bulk, Duotone, and Twotone styles.
...
2. **TypeScript errors?**
   - Ensure your `tsconfig.json` includes `"jsx": "preserve"` and `"jsxImportSource": "solid-js"`
