...
Hugeicons is a beautiful [icon library](https://hugeicons.com/react-icons) for modern web and mobile apps. The free package includes 6,000+ Stroke Rounded React icons. The Pro package provides 60,000+ React icons across 10 styles, including multicolor support for Bulk, Duotone, and Twotone styles.
...
### Key Highlights
- **6,000+ Free Icons**: Stroke Rounded set for unlimited personal and commercial projects
- **60,000+ Pro Icons, 10 Styles**: Stroke, Solid, Bulk, Duotone, and Twotone families for sharp, rounded, and standard needs with richer variants
...
> **Want access to 60,000+ icons and 10 unique styles?** 
